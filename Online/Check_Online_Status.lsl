// Check Online Status ver. 1.0
// Created 27-Feb-2026 by Missy Restless
//
// Read a notecard of Second Life user UUIDs to check.
// For each UUID display that user's online status.
// You do not need to be friends with the user.
// If user has set their profile to invisible it will not work.
