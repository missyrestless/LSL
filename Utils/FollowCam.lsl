...
list MENU_MAIN = ["Default", "Overhead Cam", "Spin Cam", "Trap Toggle", "Rear Cam", "Drop Cam", "Worm Cam", "Side Cam", "Driving Cam", "More...", "Cam ON", "Cam OFF"]; // the main menu
list MENU_2 = ["More...", "Spaz Cam", "...Back"]; // menu 2
 
integer on = FALSE;
// integer flying; doesn't seem to be used
// integer falling; doesn't seem to be used
// integer spaz = 0; doesn't seem to be used
integer trap = 0;
...
rear_cam()
{
    llOwnerSay("rear_cam"); // say function name for debugging
    ...
    llSetCameraParams([
        ...
        CAMERA_FOCUS, camPos, // region relative position
        CAMERA_FOCUS_LAG, 0.5 , // (0 to 3) seconds
        CAMERA_FOCUS_LOCKED, FALSE, // (TRUE or FALSE)
        CAMERA_FOCUS_THRESHOLD, 0.0, // (0 to 4) meters
        CAMERA_PITCH, 0.0, // (-45 to 80) degrees
        CAMERA_POSITION, camPos + <-4,0,4>, // region relative position
        CAMERA_POSITION_LAG, 0.0, // (0 to 3) seconds
        CAMERA_POSITION_LOCKED, FALSE, // (TRUE or FALSE)
        CAMERA_POSITION_THRESHOLD, 0.0, // (0 to 4) meters
