...
startAnim()
{
    llSetTextureAnim(ANIM_ON | LOOP, 2, 4, 4, 0, 16, fps);
}
    ...
    state_entry()
    {
		...
		startAnim();
         llSetPrimitiveParams([
            PRIM_NAME, "DeepThroat1024.gif",
            PRIM_DESC, "DeepThroat1024.gif made with http://www.mrmonke.net/"
      ]);
    }
