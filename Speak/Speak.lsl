...
//
// a. Make a cube prim. Create a new script, and replace the contents of that
//    script with this script. Get the script from the above download link, as
//    the code shown in the HTML are below can cause problems with scripts that
//    contain HTML.
//
// b. Be sure to give the prim a good name. The name of the prim shows up in
//    the upper right hand corner of Viewer 2 in the media panel. When a user
//    hears your prim, and wants to mute it, they can find it easily when it
//    has a good name.
//
...
Say(string msg)
{
    ...
    [
        ...
        PRIM_MEDIA_HEIGHT_PIXELS,400,      // Height and width of media texture
...
default
{
    state_entry()
    {
         ...
         llListen(0,"","","");  // change this 0 to any private channel 
                                // to control this with another script
    }
