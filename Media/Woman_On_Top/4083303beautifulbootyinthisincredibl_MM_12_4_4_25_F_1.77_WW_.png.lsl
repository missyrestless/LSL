...
startAnim()
{
    llSetTextureAnim(ANIM_ON | LOOP, 2, 4, 4, 0, 12, fps);
}
    ...
    state_entry()
    {
		...
		startAnim();
         llSetPrimitiveParams([
            PRIM_NAME, "4083303beautifulbootyinthisincrediblehardcorevaginaanimated.gif",
            PRIM_DESC, "4083303beautifulbootyinthisincrediblehardcorevaginaanimated.gif made with http://www.mrmonke.net/"
      ]);
    }
