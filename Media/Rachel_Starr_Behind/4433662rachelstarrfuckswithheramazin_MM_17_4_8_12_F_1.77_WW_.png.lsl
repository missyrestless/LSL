...
startAnim()
{
    llSetTextureAnim(ANIM_ON | LOOP, 2, 4, 8, 0, 17, fps);
}
    ...
    state_entry()
    {
		...
		startAnim();
         llSetPrimitiveParams([
            PRIM_NAME, "4433662rachelstarrfuckswithheramazingass.gif",
            PRIM_DESC, "4433662rachelstarrfuckswithheramazingass.gif made with http://www.mrmonke.net/"
      ]);
    }
